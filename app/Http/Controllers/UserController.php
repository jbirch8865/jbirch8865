...
class UserController extends Controller
{
    ...
    {
        $user = new \app\Helpers\User('default','skip_check',$this->toolbelt->Use_Objects()->Get_Company(false),false,false);
        $user->Set_Active_Status(true);
        return $this->toolbelt->Use_Functions()->Response_201(['message' => 'Default User Enabled',
